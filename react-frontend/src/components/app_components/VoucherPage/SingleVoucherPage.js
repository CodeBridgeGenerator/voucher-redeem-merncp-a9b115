...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Points</label><p className="m-0 ml-3" >{_entity?.points}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Image</label><p className="m-0 ml-3" >{_entity?.image}</p></div>
