...
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.voucherid}</p>
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.userid}</p>
const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.quantity}</p>
const pTemplate4 = (rowData, { rowIndex }) => <p >{rowData.completeddate}</p>
...
<Column field="voucherid" header="Voucherid" body={pTemplate1} filter={selectedFilterFields.includes("voucherid")} hidden={selectedHideFields?.includes("voucherid")}  sortable style={{ minWidth: "8rem" }} />
<Column field="userid" header="Userid" body={pTemplate2} filter={selectedFilterFields.includes("userid")} hidden={selectedHideFields?.includes("userid")}  sortable style={{ minWidth: "8rem" }} />
<Column field="quantity" header="Quantity" body={pTemplate3} filter={selectedFilterFields.includes("quantity")} hidden={selectedHideFields?.includes("quantity")}  sortable style={{ minWidth: "8rem" }} />
<Column field="completeddate" header="Completeddate" body={pTemplate4} filter={selectedFilterFields.includes("completeddate")} hidden={selectedHideFields?.includes("completeddate")}  sortable style={{ minWidth: "8rem" }} />
