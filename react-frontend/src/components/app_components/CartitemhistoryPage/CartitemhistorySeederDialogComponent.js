...
import seederData from "./cartitemhistory.seeder.json";
...
const CartitemhistorySeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CartitemhistorySeederDialogComponent);
