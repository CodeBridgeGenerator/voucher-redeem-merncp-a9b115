...
import seederData from "./catergory.seeder.json";
...
const CatergorySeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CatergorySeederDialogComponent);
