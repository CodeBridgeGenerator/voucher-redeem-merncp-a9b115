...
import seederData from "./cartitems.seeder.json";
...
const CartitemsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CartitemsSeederDialogComponent);
