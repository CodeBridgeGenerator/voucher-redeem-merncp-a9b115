...
quantity: _entity?.quantity,
        ...
        const result = await client.service("cartitems").patch(_entity._id, _data);
        props.onHide();
    ...
    return (
        <Dialog header="Edit Cartitems" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
